...
class TestTensorOperations:
    ...
    def test_mpytatrix_multiplication(self):
        """
        ...
        (mxn) @ (nxp) = (mxp) - inner dimensions must match.
        """
        try:
            from tinytorch.core.tensor import Tensor

            t1 = Tensor([[1, 2], [3, 4]])  # 2x2
            t2 = Tensor([[5, 6], [7, 8]])  # 2x2
...
class TestTensorMemory:
    ...
    def test_tensor_memory_efficiency(self):
        ...
        try:
            ...
            # Create a 1000x1000 tensor (1 million elements)
...
class TestTensorReshaping:
    ...
    def test_tensor_flatten(self):
        ...
        try:
            ...
            t = Tensor(np.random.randn(2, 3, 4))  # 2x3x4 = 24 elements
